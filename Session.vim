...
nmap ys <Plug>Ysurround
nnoremap <SNR>138_: :=v:count ? v:count : ''
...
silent only
silent tabonly
cd ~/Documents/Development/WriteLater
...
wincmd w
argglobal
if bufexists("Output.md") | buffer Output.md | else | edit Output.md | endif
balt arguments.php
let s:cpo_save=&cpo
set cpo&vim
...
tabnext 1
badd +23 main.php
badd +38 arguments.php
badd +18 prep.php
badd +7 list.php
badd +15 helper.php
badd +4 Subfiles/Charles_Background.md
badd +21 replace.php
badd +1 Output.md
badd +0 .gitignore
